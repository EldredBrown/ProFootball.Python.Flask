...
def edit(id: int):
    ...
    if old_division:
        ...
        if form.validate_on_submit():
            ...
            try:
                new_division = division_factory.create_division(**kwargs)
            ...
            form.name.data = old_division.name
            form.league_name.data = old_division.league_name
            form.conference_name.data = old_division.conference_name
            form.first_season_year.data = old_division.first_season_year
            form.last_season_year.data = old_division.last_season_year
