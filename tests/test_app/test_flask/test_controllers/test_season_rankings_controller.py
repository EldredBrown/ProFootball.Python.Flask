...
import app.flask.season_rankings_controller as season_rankings_controller
...
def test_index_should_render_offensive_rankings_index_template(
    ...
    with test_app.app_context():
        result = season_rankings_controller.index()
...
def test_select_season_should_render_rankings_index_template_for_selected_year(
    ...
    with test_app.app_context():
        with test_app.test_request_context(
            ...
            # Act
            result = season_rankings_controller.select_season()
