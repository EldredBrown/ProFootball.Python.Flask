...
def test_get_leagues_should_get_leagues(test_app, test_repo):
...
def test_get_league_when_leagues_is_empty_should_return_none(fake_league, test_app, test_repo):
    with test_app.app_context():
        # Arrange
        leagues_in = []
...
def test_get_league_when_leagues_is_not_empty_and_league_is_not_found_should_return_none(
        fake_league, test_app, test_repo
):
    with test_app.app_context():
        # Arrange
        leagues_in = [
...
@patch('app.data.repositories.league_repository.League')
def test_get_league_by_name_when_leagues_is_empty_should_return_none(fake_league, test_app, test_repo):
    with test_app.app_context():
        # Arrange
        leagues_in = []
        fake_league.query.all.return_value = leagues_in
        ...
        # Act
        league_out = test_repo.get_league_by_name("L1")
...
def test_get_league_by_name_when_leagues_is_not_empty_and_league_with_short_name_is_not_found_should_return_none(
    ...
    with test_app.app_context():
        ...
        # Act
        league_out = test_repo.get_league_by_name("L4")
...
def test_get_league_by_name_when_leagues_is_not_empty_and_league_with_name_is_found_should_return_league(
    ...
    with test_app.app_context():
        ...
        # Act
        league_out = test_repo.get_league_by_name("L2")
...
def test_add_league_when_no_integrity_error_caught_should_add_league(fake_sqla, test_app, test_repo):
    with test_app.app_context():
        # Arrange
        league_in = League(
            short_name="L1",
...
@patch('app.data.repositories.league_repository.sqla')
def test_add_leagues_when_leagues_arg_is_empty_should_add_no_leagues(fake_sqla, test_app, test_repo):
    with test_app.app_context():
        # Arrange
        leagues_in = ()
...
@patch('app.data.repositories.league_repository.League')
def test_league_exists_when_league_does_not_exist_should_return_false(fake_league, test_app, test_repo):
    with test_app.app_context():
        # Arrange
        leagues = [
            League(
...
@patch('app.data.repositories.league_repository.League')
def test_league_exists_when_league_exists_should_return_true(fake_league, test_app, test_repo):
    with test_app.app_context():
        # Arrange
        leagues = [
            League(
...
def test_update_league_when_no_league_exists_with_id_should_return_league_and_not_update_database(
        fake_league_exists, fake_sqla, test_app, test_repo
):
    with test_app.app_context():
        # Arrange
...
def test_update_league_when_league_exists_with_id_and_no_integrity_error_caught_should_return_league_and_update_database(
        fake_league_exists, fake_league, fake_sqla, test_app, test_repo
):
    with test_app.app_context():
        # Arrange
...
def test_delete_league_when_league_does_not_exist_should_return_none_and_not_delete_league_from_database(
        fake_league, fake_sqla, test_app, test_repo
):
    with test_app.app_context():
        # Arrange
        leagues = [
